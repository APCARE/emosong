...
var mmm=["images\\\\angry.png","images\\\\angry.png","images\\\\angry.png","images\\\\happy.png","images\\\\happy.png","images\\\\sad.png","images\\\\sad.png","images\\\\sad.png","images\\\\nutral.png","images\\\\nutral.png"];
...
function addq(elem){
	...
	//l.appendChild(text);
	l.setAttribute("style", "font-size: 15px; font-family: Comic Sans MS;");
...
function displayQueue(){
	if(document.getElementById("queue").offsetParent === null){

		document.getElementById("queue").setAttribute("style", "text-align: center;")
	}
	 else {
		document.getElementById("queue").setAttribute("style", "text-align: center; display: none;")
	}
}
...
async function getTime() {
	let url = '/api/v1/get_emotion';
	let emotion_settings = {
		"url": url,
		"method": "GET",
		"timeout": 0,
		"headers": {
	...
	$.ajax(emotion_settings).done(function (resp) {
		let value = resp.data
		console.log(value)
		if(value=="angry")
			moody(0);
